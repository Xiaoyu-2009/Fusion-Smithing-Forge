package karashokleo.fusion_smithing_forge;

import karashokleo.fusion_smithing_forge.config.FSConfig;
import karashokleo.fusion_smithing_forge.item.FusionSmithingTemplateItem;
import karashokleo.fusion_smithing_forge.recipe.SmithingFusionRecipeSerializer;
...
public class FusionSmithing {
    public static final String MOD_ID = "fusion_smithing_forge";
    public static final String RESOURCE_PREFIX = "fusion_smithing_forge";
